    ...
    <Card className="flex flex-col gap-2 bg-background p-3">
      ...
      <div className="flex flex-row gap-3">
        <Champs
          ...
          id={"name"}
          type={"text"}
          label={t("labels.actions.name")}
          placeholder={t("placeholders.actions.name")}
          value={name}
          setValue={setName}
          onChange={onChange}
        />
        <Champs
          ...
          id={"type"}
          type={"text"}
          label={t("labels.actions.type")}
          placeholder={t("placeholders.actions.type")}
          value={type}
          setValue={setType}
          onChange={onChange}
        />
        <Champs
          ...
          id={"attackBonus"}
          type={"text"}
          label={t("labels.actions.attackBonus")}
          placeholder={t("placeholders.actions.attackBonus")}
          value={attackBonus}
      ...
      <div className="flex flex-row gap-3">
        <Champs
          ...
          id={"damageType"}
          type={"text"}
          label={t("labels.actions.damage.type")}
          placeholder={t("placeholders.actions.damage.type")}
          value={damageType}
        ...
        <Champs
          ...
          id={"damageDice"}
          type={"text"}
          label={t("labels.actions.damage.dice")}
          placeholder={t("placeholders.actions.damage.dice")}
          value={damageDice}
          setValue={setDamageDice}
          onChange={onChange}
        />
        <Champs
          isActive={isUpdating}
          ...
          id={"range"}
          type={"text"}
          label={t("labels.actions.range")}
          placeholder={t("placeholders.actions.range")}
          value={range}
          setValue={setRange}
          onChange={onChange}
        />
