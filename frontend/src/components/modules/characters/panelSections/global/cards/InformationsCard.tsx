      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-row gap-2">
          ...
          <Champs
            ...
            id={"currentHP"}
            type={"number"}
            label={t("labels.stats.currentHP")}
            placeholder={t("placeholders.stats.currentHP")}
            value={currentHitPoints}
            setValue={setCurrentHP}
          />
        </div>
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"armorClass"}
            type={"number"}
            label={t("labels.stats.armorClass")}
            placeholder={t("placeholders.stats.armorClass")}
            value={armorClass}
          ...
          <Champs
            ...
            id={"hitDice"}
            type={"text"}
            label={t("labels.stats.hitDice")}
            placeholder={t("placeholders.stats.hitDice")}
            value={hitDice}
            setValue={setHitDice}
          />
        </div>
