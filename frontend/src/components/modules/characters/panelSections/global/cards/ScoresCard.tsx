      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-col gap-2">
          <CustomInput
            ...
            placeholder={t("placeholders.stats.abilityScores")}
          />
          <CustomInput
            isActive={isUpdating}
            onChange={onChangeSavingThrows}
            value={savingThrowStrength}
            setValue={setSavingThrowStrength}
            placeholder={t("placeholders.stats.savingThrows")}
          />
        </div>
      </Card>
      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <CustomInput
            isActive={isUpdating}
            onChange={onChangeSavingThrows}
            value={savingThrowDexterity}
            setValue={setSavingThrowDexterity}
            placeholder={t("placeholders.stats.savingThrows")}
          />
        </div>
      </Card>
      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <CustomInput
            isActive={isUpdating}
            onChange={onChangeSavingThrows}
            value={savingThrowConstitution}
            setValue={setSavingThrowConstitution}
            placeholder={t("placeholders.stats.savingThrows")}
          />
        </div>
      </Card>
      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <CustomInput
            isActive={isUpdating}
            onChange={onChangeSavingThrows}
            value={savingThrowIntelligence}
            setValue={setSavingThrowIntelligence}
            placeholder={t("placeholders.stats.savingThrows")}
          />
        </div>
      </Card>
      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <CustomInput
            isActive={isUpdating}
            onChange={onChangeSavingThrows}
            value={savingThrowWisdom}
            setValue={setSavingThrowWisdom}
            placeholder={t("placeholders.stats.savingThrows")}
          />
        </div>
      </Card>
      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <CustomInput
            isActive={isUpdating}
            onChange={onChangeSavingThrows}
            value={savingThrowCharisma}
            setValue={setSavingThrowCharisma}
            placeholder={t("placeholders.stats.savingThrows")}
          />
        </div>
      </Card>
