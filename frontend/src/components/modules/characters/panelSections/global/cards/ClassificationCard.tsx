      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"type"}
            type={"text"}
            label={t("labels.classification.type")}
            placeholder={t("placeholders.classification.type")}
            value={type}
            setValue={setType}
          />
          <Champs
            ...
            id={"subType"}
            type={"text"}
            label={t("labels.classification.subType")}
            placeholder={t("placeholders.classification.subType")}
            value={subType}
            setValue={setSubType}
          />
        </div>
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"alignment"}
            type={"text"}
            label={t("labels.classification.alignment")}
            placeholder={t("placeholders.classification.alignment")}
            value={alignment}
          ...
          <Champs
            ...
            id={"size"}
            type={"text"}
            label={t("labels.classification.size")}
            placeholder={t("placeholders.classification.size")}
            value={size}
            setValue={setSize}
          />
        </div>
