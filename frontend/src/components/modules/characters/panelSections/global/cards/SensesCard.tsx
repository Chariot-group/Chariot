      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"nightVision"}
            type={"number"}
            label={t("labels.stats.senses.nightVision")}
            placeholder={t("placeholders.stats.senses.nightVision")}
            value={darkvision}
          ...
          <Champs
            ...
            type={"number"}
            label={t("labels.stats.senses.passivePerception")}
            placeholder={t("placeholders.stats.senses.passivePerception")}
            value={passivePerception}
            setValue={setPassivePerception}
          />
        </div>
      </Card>
    </div>
