      ...
      <Card className="flex w-full flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"walk"}
            type={"number"}
            label={t("labels.stats.speed.walk")}
            placeholder={t("placeholders.stats.speed.walk")}
            value={walk}
            setValue={setWalk}
          />
          <Champs
            ...
            id={"swim"}
            type={"number"}
            label={t("labels.stats.speed.swim")}
            placeholder={t("placeholders.stats.speed.swim")}
            value={swim}
            setValue={setSwim}
          />
          <Champs
            ...
            id={"climb"}
            type={"number"}
            label={t("labels.stats.speed.climb")}
            placeholder={t("placeholders.stats.maxHP")}
            value={climb}
            setValue={setClimb}
          />
        </div>
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"maxHP"}
            type={"number"}
            label={t("labels.stats.speed.fly")}
            placeholder={t("placeholders.stats.speed.fly")}
            value={fly}
            setValue={setFly}
          />
          <Champs
            ...
            id={"maxHP"}
            type={"number"}
            label={t("labels.stats.speed.burrow")}
            placeholder={t("placeholders.stats.speed.burrow")}
            value={burrow}
            setValue={setBurrow}
          />
        </div>
