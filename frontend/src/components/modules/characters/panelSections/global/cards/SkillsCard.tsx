      ...
      <Card className="flex flex-col gap-2 bg-background p-3">
        ...
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"athletic"}
            type={"number"}
            label={t("labels.stats.skills.athletics")}
            placeholder={t("placeholders.stats.skills.athletics")}
            value={athletics}
            setValue={setAthletics}
          />
          <Champs
            isActive={isUpdating}
            onChange={onChange}
            ...
            id={"acrobatics"}
            type={"number"}
            label={t("labels.stats.skills.acrobatics")}
            placeholder={t("placeholders.stats.skills.acrobatics")}
            value={acrobatics}
            setValue={setAcrobatics}
          />
          <Champs
            isActive={isUpdating}
            onChange={onChange}
            ...
            id={"stealth"}
            type={"number"}
            label={t("labels.stats.skills.stealth")}
            placeholder={t("placeholders.stats.skills.stealth")}
            value={stealth}
            setValue={setStealth}
          />
          <Champs
            ...
            id={"perception"}
            type={"number"}
            label={t("labels.stats.skills.perception")}
            placeholder={t("placeholders.stats.skills.perception")}
            value={perception}
        ...
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"intimidation"}
            type={"number"}
            label={t("labels.stats.skills.intimidation")}
            placeholder={t("placeholders.stats.skills.intimidation")}
            value={intimidation}
          ...
          <Champs
            ...
            id={"arcana"}
            type={"number"}
            label={t("labels.stats.skills.arcana")}
            placeholder={t("placeholders.stats.skills.arcana")}
            value={arcana}
            setValue={setArcana}
          />
          <Champs
            ...
            id={"history"}
            type={"number"}
            label={t("labels.stats.skills.history")}
            placeholder={t("placeholders.stats.skills.history")}
            value={history}
            setValue={setHistory}
          />
          <Champs
            ...
            id={"survival"}
            type={"number"}
            label={t("labels.stats.skills.survival")}
            placeholder={t("placeholders.stats.skills.survival")}
            value={survival}
        ...
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"investigation"}
            type={"number"}
            label={t("labels.stats.skills.investigation")}
            placeholder={t("placeholders.stats.skills.investigation")}
            value={investigation}
            setValue={setInvestigation}
          />
          <Champs
            isActive={isUpdating}
            onChange={onChange}
            ...
            id={"nature"}
            type={"number"}
            label={t("labels.stats.skills.nature")}
            placeholder={t("placeholders.stats.skills.nature")}
            value={nature}
            setValue={setNature}
          />
          <Champs
            ...
            id={"religion"}
            type={"number"}
            label={t("labels.stats.skills.religion")}
            placeholder={t("placeholders.stats.skills.religion")}
            value={religion}
          ...
          <Champs
            ...
            id={"deception"}
            type={"number"}
            label={t("labels.stats.skills.deception")}
            placeholder={t("placeholders.stats.skills.deception")}
            value={deception}
            setValue={setDeception}
          />
        </div>
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"performance"}
            type={"number"}
            label={t("labels.stats.skills.performance")}
            placeholder={t("placeholders.stats.skills.performance")}
            value={performance}
          ...
          <Champs
            ...
            id={"insight"}
            type={"number"}
            label={t("labels.stats.skills.insight")}
            placeholder={t("placeholders.stats.skills.insight")}
            value={insight}
            setValue={setInsight}
          />
          <Champs
            ...
            id={"medicine"}
            type={"number"}
            label={t("labels.stats.skills.medicine")}
            placeholder={t("placeholders.stats.skills.medicine")}
            value={medicine}
          ...
          <Champs
            ...
            id={"persuasion"}
            type={"number"}
            label={t("labels.stats.skills.persuasion")}
            placeholder={t("placeholders.stats.skills.persuasion")}
            value={persuasion}
            setValue={setPersuasion}
          />
        </div>
        <div className="flex flex-row gap-2">
          <Champs
            ...
            id={"sleightOfHand"}
            type={"number"}
            label={t("labels.stats.skills.sleightOfHand")}
            placeholder={t("placeholders.stats.skills.sleightOfHand")}
            value={sleightHand}
            setValue={setSleightHand}
          />
          <Champs
            isActive={isUpdating}
            onChange={onChange}
            ...
            id={"animalHandling"}
            type={"number"}
            label={t("labels.stats.skills.animalHandling")}
            placeholder={t("placeholders.stats.skills.animalHandling")}
            value={animalHandling}
            setValue={setAnimalHandling}
          />
        </div>
      </Card>
    </div>
