...
export default function Details({ npc, isUpdate, updateNpc }: Props) {
    ...
    return (
        <Card className="bg-card p-4 flex flex-col bg-background">
            <Champs label="Vision dans le noir" value={darkvision} id={"darkvision"} type={"number"} placeholder={"Vision dans le noir"} isActive={isUpdate} setValue={changeDarkvision} />
