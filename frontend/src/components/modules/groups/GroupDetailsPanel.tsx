    ...
    return (
        <div className="flex flex-col h-full w-full gap-3 p-5">
            ...
            <div className="w-full">
                ...
                <Textarea readOnly={!isUpdating} className="rounded-xl h-[13vh] resize-none bg-card border-ring" placeholder={t("placeholders.description")} value={description} onChange={(e) => setDescription(e.target.value)}/>
            </div>
        </div>
    );
