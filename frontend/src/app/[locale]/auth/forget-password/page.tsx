        ...
        <div className="w-full h-[100dvh] gap-1 flex flex-col items-center bg-background">
            <div className="w-[40%] h-1/3 flex flex-col justify-center ">
                <ul className="steps w-full">
                    <li className={`step ${step >= 1 && 'step-primary'}`}>{t('step.step1')}</li>
                    <li className={`step ${step >= 2 && 'step-primary'}`}>{t('step.step2')}</li>
                    <li className={`step ${step == 3 && 'step-primary'}`}>{t('step.step3')}</li>
                </ul>
            </div>
            <Card className="w-[40%] shadow-md relative">
                ...
                {
                    step === 1 &&
                    <ConfirmEmail setStep={setStep} setUserId={setUserId} />
                }
                {
                    step === 2 &&
            ...
            </Card>
            {
                ...
                <div className="w-[40%] flex flex-row items-left ">
                    <div className="flex flex-col items-left">
                        <Button variant={"link"} className="text-sm text-foreground p-0" onClick={() => setStep(1)}>{t("wrongEmail")}</Button>
                    </div>
                </div>
            }
        </div>
